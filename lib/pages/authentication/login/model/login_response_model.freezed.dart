...
abstract class $LoginResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonSerializable(explicitToJson: true) String token});
}
...
class _$_LoginResponseModel implements _LoginResponseModel {
  const _$_LoginResponseModel(
      {@JsonSerializable(explicitToJson: true) required this.token});
...
abstract class _LoginResponseModel implements LoginResponseModel {
  const factory _LoginResponseModel(
      {@JsonSerializable(explicitToJson: true)
          required final String token}) = _$_LoginResponseModel;
